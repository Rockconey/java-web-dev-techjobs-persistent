...
public class AuthenticationController {
    ...
    public String processRegristationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO,
        ...
        newUser.setName(registerFormDTO.getUsername());
    ...
    @GetMapping("/login")
    public String displayLoginFormDTO(Model model) {
